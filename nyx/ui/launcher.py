...
class NyxLauncherWindow(Gtk.ApplicationWindow):
    ...
    def _build_layout(self) -> None:
        ...
        stage = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=10)
        ...
        response_card.add_css_class("nyx-shell-card")
        stage.append(response_card)

        response_inner = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=0)
        response_inner.add_css_class("nyx-inner-card")
        response_card.append(response_inner)
        ...
        response_inner.append(response_scroll)
        ...
        input_card.add_css_class("nyx-shell-card")
        stage.append(input_card)

        input_inner = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=0)
        input_inner.add_css_class("nyx-inner-card-alt")
        input_card.append(input_inner)
        ...
        self.prompt_view.set_size_request(-1, 82)
        self.prompt_view.add_css_class("nyx-popup-input")
        input_inner.append(self.prompt_view)
